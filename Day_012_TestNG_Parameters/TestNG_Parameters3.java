...
public class TestNG_Parameters3 {
	
	static WebDriver driver;

	@Parameters({"Browser","UserName","Password","Nationality"})
	@Test
	public static void Login_Test(String Browser,String UserName,String Password,String Nationality) throws Exception
	{
	   ...
	   // TC02_Login_Static_Paarameters1.OpenChromeBrowser();
		TestNG_Parameters3.OpenOrangeHRM();
		TestNG_Parameters3.Login(UserName,Password);
		TestNG_Parameters3.AddNationalities(Nationality);
